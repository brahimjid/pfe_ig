...
<div id='target'>
    <!------------------------header------------------------------>
    <table width="100%" height="100px"  style="text-align:left; float:top;left;">
          ...
          d'Administration d'Entreprises
           ...
           <th></th>
            <th width='40%'  style="text-align:center">
                ...
                <br>Profil: 
                @foreach($grp as $g)
                {{$g->titre}} ({{$g->titreCourt}}-G{{$g->ordre}})
                @endForeach
                <br>
                  &nbsp;&nbsp;
            </th>
...
if($ligne<10){
   ...
   if(!empty($event[$col][$ligne]) ){
      // $rowspan[$col-1]=date('H',strtotime($event[$col][$ligne]['hF']))-date('H',strtotime($event[$col][$ligne]['hD']));
       ...
       echo $event[$col][$ligne]['mat'];
       echo ', Par: '.$event[$col][$ligne]['Nom'];
       echo ', Salle: '.$event[$col][$ligne]['idSalle'];
       echo 'm '.$event[$col][$ligne]['typeCours'];
   ...
   if(!empty($event[$col][$ligne]) ){
       ...
       echo ', Par: '.$event[$col][$ligne]['Nom'];
       echo ', Salle: '.$event[$col][$ligne]['idSalle'];
       echo ', '.$event[$col][$ligne]['typeCours'];
       // echo ''.$event[$col][$ligne]['idGroupe'];
